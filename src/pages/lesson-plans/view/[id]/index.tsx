...
import { useLessonPlanFindFirst, useRoqClient } from 'lib/roq';
...
function LessonPlanViewPage() {
  ...
  const { data, error, isLoading } = useLessonPlanFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('lesson_plan', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/lesson-plans/edit/${id}`} passHref legacyBehavior>
                    <Button
