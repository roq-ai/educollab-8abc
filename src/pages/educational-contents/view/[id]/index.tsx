...
import { useEducationalContentFindFirst, useRoqClient } from 'lib/roq';

import { EducationalContentInterface } from 'interfaces/educational-content';

function EducationalContentViewPage() {
  ...
  const { data, error, isLoading } = useEducationalContentFindFirst(queryParams, {}, { disabled: !id });
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Educational Content Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('educational_content', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/educational-contents/edit/${id}`} passHref legacyBehavior>
                    <Button
