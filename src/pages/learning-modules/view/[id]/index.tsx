...
import { useLearningModuleFindFirst, useRoqClient } from 'lib/roq';

import { LearningModuleInterface } from 'interfaces/learning-module';

function LearningModuleViewPage() {
  ...
  const { data, error, isLoading } = useLearningModuleFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('learning_module', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/learning-modules/edit/${id}`} passHref legacyBehavior>
                    <Button
